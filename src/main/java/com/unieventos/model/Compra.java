...
public class Compra implements Serializable {
    ...
    private String cupon; // opcional, si se usa un cupón

    // Constructor
    public Compra(Cliente cliente, Evento evento, String localidad, int cantidadEntradas, double subtotal, double total, String cupon) {
    ...
    public Compra(Usuario usuarioLogueado, Evento eventoSeleccionado, Localidad localidadSeleccionada, int cantidadEntradas, double total) {
    }
